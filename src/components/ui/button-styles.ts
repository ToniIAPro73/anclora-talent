export const premiumPrimaryMintButton =
  'inline-flex min-h-12 items-center justify-center gap-2 whitespace-nowrap rounded-full bg-[var(--button-highlight-bg)] px-6 py-3 text-sm font-semibold text-[var(--button-highlight-fg)] shadow-[var(--shadow-soft)] transition hover:bg-[var(--button-highlight-hover)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--button-highlight-bg)] focus-visible:ring-offset-2';
