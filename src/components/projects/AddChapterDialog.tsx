    ...
    >
      <div className="ac-modal-backdrop min-h-screen p-4 sm:p-6">
        ...
        <div className="ac-modal__header mb-1">
          ...
          <button
            data-testid="add-chapter-close-button"
            onClick={handleClose}
            disabled={isSaving}
        ...
        <form onSubmit={handleSubmit} className="ac-modal__body space-y-4">
          ...
          <label className="ac-form-field">
            ...
            <input
              type="text"
              data-testid="add-chapter-title-input"
              value={title}
          ...
          <label className="ac-form-field">
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2">
                <input
                  type="radio"
                  data-testid="add-chapter-position-end-radio"
                  value="end"
              ...
              <label className="flex items-center gap-2">
                <input
                  type="radio"
                  data-testid="add-chapter-position-before-radio"
                  value="before"
              ...
              {position === 'before' && chapters.length > 0 && (
                <select
                  data-testid="add-chapter-position-before-select"
              ...
              <label className="flex items-center gap-2">
                <input
                  type="radio"
                  data-testid="add-chapter-position-after-radio"
                  value="after"
              ...
              {position === 'after' && chapters.length > 0 && (
                <select
                  data-testid="add-chapter-position-after-select"
                  value={selectedChapterId}
                  onChange={(e) => setSelectedChapterId(e.target.value)}
                  disabled={isSaving}
                  className="field-select ml-6"
          ...
          <div className="ac-modal__footer flex gap-3 pt-4">
            <button
              type="button"
              data-testid="add-chapter-cancel-button"
              onClick={handleClose}
              disabled={isSaving}
            ...
            <button
              type="submit"
              data-testid="add-chapter-submit-button"
