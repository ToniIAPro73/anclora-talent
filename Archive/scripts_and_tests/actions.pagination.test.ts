...
vi.mock('../../src/lib/projects/chapter-html', () => ({
  chapterBlocksToHtml: vi.fn(() => '<p>Indice</p>'),
}));

import { syncProjectPaginationAction } from '../../src/lib/projects/actions';
...
describe('syncProjectPaginationAction - regresion numeracion', () => {
  beforeEach(async () => {
    ...
    const { chapterBlocksToHtml } = await import('../../src/lib/projects/chapter-html');
